...
static bool
ReadClusters(PEXTXVOL pExt2, PVOID dest, HUGE_ LCN, UINT nClusters)
{
   HUGE_ LBA;
...
PUBLIC bool
Extx_IsLinuxVolume(HVDDR hVDI, HUGE_ iLBA)
{
